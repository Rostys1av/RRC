...
WebUI.click(findTestObject('Object Repository/Header-Footer/link-details detail'))

WebUI.switchToWindowIndex(2)

WebUI.waitForElementPresent(findTestObject('Header-Footer/Ver_Buttons/ver_detail_report_page'), 0)
