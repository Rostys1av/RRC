...
WebUI.click(findTestObject('Login_registration/div_Forgot password'))

WebUI.delay(1)

WebUI.setText(findTestObject('Login_registration/input_in_key_password_recover'), '111111')

WebUI.setText(findTestObject('Login_registration/input_in_password_new'), '111111')

WebUI.setText(findTestObject('Login_registration/input_in_password_confirm'), '1111111')

WebUI.click(findTestObject('Login_registration/button_LOG IN_recover_password'))

WebUI.waitForElementPresent(findTestObject('Login_registration/Error_message_Key entered incorrectly'), 5)
