...
WebUI.setText(findTestObject('Login_registration/input_in_password_confirm'), '111111111')

WebUI.click(findTestObject('Login_registration/button_LOG IN_recover_password'))

WebUI.waitForElementPresent(findTestObject('Login_registration/Error_message_Passwords do not match'), 5)
